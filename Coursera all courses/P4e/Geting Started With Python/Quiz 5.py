...
Question 1
get_ipython().set_next_input('What do we do to a Python statement that is immediately after an if statement to indicate that the statement is to be executed only when the if statement is true');get_ipython().run_line_magic('pinfo', 'true')
...
Question 4
get_ipython().set_next_input('When you have multiple lines in an if block, how do you indicate the end of the if block');get_ipython().run_line_magic('pinfo', 'block')
...
Question 6
get_ipython().set_next_input('What is the Python reserved word that we use in two-way if tests to indicate the block of code that is to be executed if the logical test is false');get_ipython().run_line_magic('pinfo', 'false')
toggle
switch
else
...
Question 7
get_ipython().set_next_input('What will the following code print out');get_ipython().run_line_magic('pinfo', 'out')
x = 0
if x < 2 :
    print 'Small'
elif x < 10 :
...
get_ipython().set_next_input("What value of 'x' will cause 'Something else' to print out");get_ipython().run_line_magic('pinfo', 'out')
x = -22
x = -2.0
...
Question 9
get_ipython().set_next_input("'In the following code (numbers added) - which will be the last line to execute successfully");get_ipython().run_line_magic('pinfo', 'successfully')
(1)   astr = 'Hello Bob'
(2)   istr = int(astr)
(3)   print 'First', istr
(4)   astr = '123'
...
try:
    ...
    istr = -1
get_ipython().set_next_input('What will the value for istr after this code executes');get_ipython().run_line_magic('pinfo', 'executes')
false
